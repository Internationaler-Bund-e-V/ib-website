...
class PluginUpdaterDBProductList implements UpgradeWizardInterface
{
    private string $list_type_org = 'ibcontent_dbproductlist';
    private const MIGRATION_SETTINGS = [
        [
            'switchableControllerActions' => 'MyContent->dbShowCategory',
            'targetListType' => 'ibcontent_dbproductlistshowcategory',
        ],
        [
            'switchableControllerActions' => 'MyContent->dbShowProduct',
            'targetListType' => 'ibcontent_dbproductlistshowproduct',
        ],
        [
            'switchableControllerActions' => 'MyContent->dbShowLocation',
            'targetListType' => 'ibcontent_dbproductlistshowlocation',
        ],
        [
            'switchableControllerActions' => 'MyContent->dbShowNews',
            'targetListType' => 'ibcontent_dbproductlistshownews',
        ],
    ];
    ...
    {
        return 'txIBContentPluginUpdaterProductList';
    }
