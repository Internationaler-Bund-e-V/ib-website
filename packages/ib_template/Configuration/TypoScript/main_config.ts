...
@import 'EXT:ib_template/Configuration/TypoScript/legacy_support.t3s'

# -----------------------------------------------------------------------------
# form configuration
# -----------------------------------------------------------------------------
#<INCLUDE_TYPOSCRIPT: source="FILE:EXT:ib_template/Configuration/TypoScript/mailform.ts">
@import 'EXT:ib_template/Configuration/TypoScript/mailform.ts'

# -----------------------------------------------------------------------------
# news configuration
# -----------------------------------------------------------------------------
#<INCLUDE_TYPOSCRIPT: source="FILE:EXT:ib_template/Configuration/TypoScript/news.ts">
@import 'EXT:ib_template/Configuration/TypoScript/news.ts'

# -----------------------------------------------------------------------------
# cookiebot configuration
# -----------------------------------------------------------------------------
#<INCLUDE_TYPOSCRIPT: source="FILE:EXT:ib_template/Configuration/TypoScript/cookiebot_setup.t3s">
@import 'EXT:ib_template/Configuration/TypoScript/cookiebot_setup.t3s'

# -----------------------------------------------------------------------------
# sitemap configuration
# -----------------------------------------------------------------------------
#<INCLUDE_TYPOSCRIPT: source="FILE:EXT:ib_template/Configuration/TypoScript/sitemap_setup.t3s">
@import 'EXT:ib_template/Configuration/TypoScript/sitemap_setup.t3s'

# -----------------------------------------------------------------------------
# robots.txt configuration
# -----------------------------------------------------------------------------
#<INCLUDE_TYPOSCRIPT: source="FILE:EXT:ib_template/Configuration/TypoScript/robots.t3s">
@import 'EXT:ib_template/Configuration/TypoScript/robots.t3s'
...
#plugin.tt_news {
     # call user function
     #imageMarkerFunc = Rms\ibNewsExt\teaserMarkerFunc->user_imageMarkerFunc
