...
exports.initChangeImgToBg = initChangeImgToBg;
/* ============================ */
/* IMAGE TO BACKGROUND */
...
function initChangeImgToBg(imgSel, parentSel) {
...
exports.initCounterAnimation = initCounterAnimation;
var _helperFunctions = require("./_helperFunctions");
/**
...
function initializeCounterAnimation() {
  ...
  if ($('.js-counter').length) {
    var counterInView = function counterInView() {
      if (!counterView) {
        if ((0, _helperFunctions.isScrolledIntoView)($counter)) {
          counterView = true;
          var counterArr = [];
    ...
    var commaSeparateNumber = function commaSeparateNumber(val) {
...
},{"./_helperFunctions":3}],3:[function(require,module,exports){
"use strict";
...
function initializeNavigation() {
  ...
  if ($('.aheto-header').length) {
    ...
    if ($('.js-center-logo').length) {
      var moveLogoToMenu = function moveLogoToMenu() {
        var $logo = $('.js-center-logo');
        var menuLength = $('.aheto-header .main-menu > .menu-item').length;
        if (0 == menuLength % 2) {
          $logo.insertAfter('.aheto-header .main-menu > .menu-item:nth-child(' + Math.floor(menuLength / 2) + ')');
        }
        logoIsMoved = true;
      };
      var moveLogoFromMenu = function moveLogoFromMenu() {
        var $logo = $('.js-center-logo');
    ...
    if ($('.js-shop-header').length) {
      var closeShopAside = function closeShopAside() {
...
function initializeNewsSlider() {
  var newsSwiper = new _swiperBundle["default"]('.Bvbbe-Swiper', {
    slidesPerView: 3,
    spaceBetween: 30,
    loop: true,
...
},{"swiper/swiper-bundle":8}],6:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initObfuscateEmail = initObfuscateEmail;
/**
...
var _counterAnimation = require("./_counterAnimation");
var _swiperBundle = _interopRequireDefault(require("swiper/swiper-bundle"));
var _newsSlider = require("./_newsSlider");
var _backgroundImage = require("./_backgroundImage");
var _obfuscateEmail = require("./_obfuscateEmail");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }
$(document).ready(function () {
  (0, _navigation.initNavigation)();
  (0, _counterAnimation.initCounterAnimation)();
  (0, _newsSlider.initNewsSlider)();
  (0, _backgroundImage.initChangeImgToBg)('.js-bg');
  (0, _obfuscateEmail.initObfuscateEmail)();
  var swiper = new _swiperBundle["default"]('.BvbbeHeadSlider', {
    slidesPerView: 1,
    autoplay: {
      delay: 1500
    },
...
},{"./_backgroundImage":1,"./_counterAnimation":2,"./_navigation":4,"./_newsSlider":5,"./_obfuscateEmail":6,"swiper/swiper-bundle":8}],8:[function(require,module,exports){
/**
 * Swiper 8.4.4
